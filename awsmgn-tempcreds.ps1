...
Start-Process -FilePath $InstallerPath -ArgumentList "--region $AWSRegion --aws-access-key-id $AWSAccessKeyId --aws-secret-access-key $AWSSecretAccessKey --aws-session-token $AWSSessionToken --no-prompt" -Wait
